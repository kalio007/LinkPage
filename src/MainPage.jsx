...
function MainPage() {
  return (
    <div className="h-full w-full p-6 flex flex-col items-center mx-auto space-y-12 mt-15 max-w-md md:max-w-5xl md:space-y-2 md:p-10">
      ...
      <div className='bg-[#110CC1] shadow-3xl flex mt-20 md:mb-6 px-8 py-3'>
       ...
       <RiTrademarkLine size={15} color='#FFFFFF'/> 
        ...
        <div className='border-dotted border-[1px] border-black w-full p-6 h-80'>
